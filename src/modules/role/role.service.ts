...
import { CreateRoleBodyType, GetRolesQueryType, UpdateRoleBodyType } from 'src/modules/role/models/role.model'
import { NotFoundRecordException } from 'src/shared/error'
import { isNotFoundPrismaError, isUniqueConstraintPrismaError } from 'src/shared/helpers'
import {
  ProhibitedActionOnBaseRoleException,
  RoleAlreadyExistsException,
} from 'src/modules/role/models/role.error.model'
import { RoleName } from 'src/shared/constants/role.constants'
import { CACHE_MANAGER } from '@nestjs/cache-manager'
import { Cache } from 'cache-manager'
import { IRoleRepository } from './repository/role.repo.interface'
